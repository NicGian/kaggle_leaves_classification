...
root = 'C:\Users\Giancarlo\Desktop\PhD\Data challenges\leaves\input'
np.random.seed(12)
...
def load_numeric_test(standardize=True):
	...
	ID = test.pop('id')
	# standardize the data by setting the mean to 0 and std to 1
	test = StandardScaler().fit(data).transform(test) if standardize else test.values
	return ID, test
...
class ImageDataGenerator2(ImageDataGenerator):
    def flow(self, X, y=None, batch_size=128, shuffle=True, seed=None,
